...
export default function Footer() {
    return (
        <div className="w-full h-auto mt-2 lg:p-5  ">
            <footer className="bg-thirdty text-white w-full h-full md:rounded-lg p-4 grid grid-rows-[1fr_auto]  grid-cols-2 sm:grid-cols-3 lg:grid-cols-5   gap-5   ">
