...
export default function RecipeCategoryCard({name, img, id}) {
    
    return (
        <a href={`#${id}`} className="  w-32 h-27 sm:w-40 sm:h-35 lg:w-48 lg:h-43  relative flex justify-center overflow-hidden rounded-md group cursor-pointer " >
